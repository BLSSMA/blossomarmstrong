    ...
    return(
        ...
        <div className="FeaturedWorks">
            <div className="title">FEATURED WORKS</div>
                <FeaturedProjects image={IntroductionToAi}project={"Introduction to AI"} dateSkill={"June 2024 | AI Integration"} paragraph={"In this lesson I was introduced to AI. I implimented an AI into the project so the user can type in any word they like and they will get back a custom romantic, rhyming poem"}/>        
                    <hr /> 
