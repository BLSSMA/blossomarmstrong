...
export default function NameCard(){
   ...
   <div className="NameCard d-grid-md">
    ...
    <h2>BLOSSOM ARMSTRONG</h2>
            ...
            <div className="resumeLink"><a href="https://docs.google.com/document/d/e/2PACX-1vRNObjh4JCaaba4LA3hOwneO-YxUQWpfRCN8cudLuSWFDUcOxfZeALd6c9dGiaewO9_coG3lSaZE9D9/pub" target="_blank" rel="noreferrer" title="view resume">VIEW RESUME</a></div>  
</section>
